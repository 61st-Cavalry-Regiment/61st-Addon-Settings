...
force force MCC_CuratorEditDisabled = true;
...
force force MCC_MessagesIndex = false;
force MCC_syncOn = true;
force force MCC_t2tIndex = 0;
force MCC_timeMultiplier_settings = 1;

// MCC Mechanics
force force MCC_allow3DSpotting = false;
...
force force MCC_disableFatigue = false;
force force MCC_ingameUI = false;
force force MCC_interaction = false;
...
force force MCC_openRespawnMenu = false;
force force MCC_respawnCinematic = false;
...
zen_faction_filter_1_61st_Aux = true;
